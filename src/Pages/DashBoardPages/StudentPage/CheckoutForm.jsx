...
const CheckoutForm = ({ classCart ,classInfo, price }) => {
  ...
  const handleSubmit = async (event) => {
    ...
    if (paymentIntent.status === "succeeded") {
      ...
      const payment = {
        ...
        price,
        date: new Date(),
        quantity: classInfo.length,
        cartItem: classCart.find((item) => item._id === classInfo._id),
        classItems: classInfo.classItemId,
        availableSeats: classInfo.availableSeats - 1,
        itemNames: classInfo.name,
      };
